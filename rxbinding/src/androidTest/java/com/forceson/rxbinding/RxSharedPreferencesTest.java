...
import com.forceson.rxbinding.content.RxSharedPreferences;
...
public class RxSharedPreferencesTest {
    ...
    private final SharedPreferences prefs = context.getSharedPreferences("test", Context.MODE_PRIVATE);
    ...
    @Test
    public void multipleChangesTrigger() {
    ...
    @Test
    public void unsubscribeDoesNotTrigger() {
        RecordingObserver<String> o = new RecordingObserver<>();
    ...
    @Test
    public void observeBooleanWithDefault() {
        RecordingObserver<Boolean> o = new RecordingObserver<>();
    ...
    @Test
    public void observeFloatWithDefault() {
        RecordingObserver<Float> o = new RecordingObserver<>();
    ...
    @Test
    public void observeIntWithDefault() {
        RecordingObserver<Integer> o = new RecordingObserver<>();
    ...
    @Test
    public void observeStringWithDefault() {
        RecordingObserver<String> o = new RecordingObserver<>();
