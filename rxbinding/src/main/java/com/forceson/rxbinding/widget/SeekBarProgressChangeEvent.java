 ...
 */
public class SeekBarProgressChangeEvent extends SeekBarChangeEvent {
    private final int progress;
    private final boolean fromUser;

    public static SeekBarProgressChangeEvent create(@NonNull SeekBar seekBar, int progress, boolean fromUser) {
        return new SeekBarProgressChangeEvent(seekBar, progress, fromUser);
    }
